...
\begin{itemize}
    ...
    \item Campaign only predictor: prediction models using features generated from campaign graph network attributes
\end{itemize}
...
\end{itemize}
For features used in the Legislator only predictor, we collected legislators' affiliated party and home state information, by congressional term. 
